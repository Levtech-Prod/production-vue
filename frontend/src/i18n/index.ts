...
const messages = {
  en: {
    ...
    dashboard: 'Dashboard',
    users: 'Users',
    projects_preparation: 'Projects Preparation',
    projects: 'Projects',
    ...
    part_name_mode: 'Part name',
    part_name_mode_custom: 'Custom',
    part_name_mode_parameters: 'Parameters',
    part_name_mode_custom_hint: 'Each part is named by hand.',
    part_name_mode_parameters_hint:
      'A part name is built from the category name and its column parameters. Any text entered is added in front.',
    generated_name: 'Generated name',
    name_optional: 'Name (optional)',
    regenerate_part_names: 'Rename parts',
    ...
    no_revisions_yet: 'This product has no revisions yet.',
    no_revisions_for_filter: 'No revision matches this filter.',
    more_revisions: '+{n} more',
    tab_overview: 'Overview',
    created_by: 'Created by',
    no_revision_selected: 'Select a revision to see its details.',
    no_change_notes: 'No change notes for this revision.',
    revision_composition: 'Composition',
    documents_progress: '{done}/{total} uploaded',
  ...
  hu: {
    ...
    users: 'Felhasználók',
    projects_preparation: 'Projektek előkészítése',
    projects: 'Projektek',
    offer_processing: 'Ajánlatfeldolgozás',
    orders: 'Rendelések',
    ...
    part_name_mode: 'Alkatrész neve',
    part_name_mode_custom: 'Egyedi',
    part_name_mode_parameters: 'Paraméterek',
    part_name_mode_custom_hint: 'Az alkatrészek nevét kézzel kell megadni.',
    part_name_mode_parameters_hint:
      'Az alkatrész neve a kategória nevéből és az oszlopként megjelenő paramétereiből áll össze. A beírt szöveg a név elejére kerül.',
    generated_name: 'Generált név',
    name_optional: 'Név (opcionális)',
    regenerate_part_names: 'Alkatrészek átnevezése',
    ...
    no_revisions_yet: 'Ehhez a termékhez még nincs revízió.',
    no_revisions_for_filter: 'Nincs a szűrésnek megfelelő revízió.',
    more_revisions: '+{n} további',
    tab_overview: 'Áttekintés',
    created_by: 'Létrehozta',
    no_revision_selected: 'Válassz revíziót a részletek megtekintéséhez.',
    no_change_notes: 'Ehhez a revízióhoz nincs változásjegyzet.',
    revision_composition: 'Összeállítás',
    documents_progress: '{done}/{total} feltöltve',
